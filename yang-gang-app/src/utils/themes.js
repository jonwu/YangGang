...
const shared = {
  ...
  yangBlue: colors.YANG_BLUE,
  yangLightBlue: colors.YANG_BLUE_LIGHT,
  yangDarkBlue: colors.YANG_BLUE_DARK,
  yangGold: colors.YANG_GOLD,
  blue: colors.BLUE,
